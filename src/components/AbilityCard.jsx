  ...
  return (
    ...
    text-slate-200 text-2xl font-bold uppercase"
      ...
      <div className="flex flex-row border-b-2 border-slate-500 py-2">
        ...
        <img
          className="ml-auto mr-4 aspect-square"
      ...
      <div id="super" className="p-2 mt-auto mb-0 bg-dank-100">
        <span className="text-blue-500 font-semibold">Super: </span>
        <span className="text-purple-200">
          {ability.superUpgrade.split("Super: ")[1]}
        </span>
      </div>
      <div id="gaben" className="p-2 bg-dank-300 mb-3">
        <span className="text-orange-400 font-semibold">Gaben: </span>
        <span>{ability.gabenUpgrade.split("Gaben: ")[1]}</span>
      </div>
      {ability.differences && (
        <div
          id="differences"
          className="p-2 mb-3 -mt-3 bg-slate-600 text-purple-400"
        >
          <span className="font-semibold">Differences from Dota: </span>
          {ability.differences}
        </div>
      )}
    </div>
